...
import com.dream11.consumer.verticle.HelixControllerVerticle;
import com.dream11.consumer.verticle.HelixParticipantConsumerVerticle;
  ...
  protected Deployable[] getVerticlesToDeploy(Vertx vertx) {
    ...
    return new Deployable[] {
      new Deployable(
          ...
          HelixParticipantConsumerVerticle.class),
      new Deployable(
