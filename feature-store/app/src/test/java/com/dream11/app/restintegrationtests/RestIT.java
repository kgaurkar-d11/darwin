...
import static com.dream11.app.expectedrequestresponse.CassandraFeatureGroupReadTestData.SuccessReadPartitionTest;
import static com.dream11.app.expectedrequestresponse.CassandraFeatureGroupReadTestData.TenantReplicatedSuccessReadFeaturesTest;
import static com.dream11.app.expectedrequestresponse.CassandraFeatureGroupReadTestData.TenantReplicatedSuccessWriteFeaturesTest;
...
import static com.dream11.app.expectedrequestresponse.LegacyStackTestData.AlterTableFeatureGroupExists;
import static com.dream11.app.expectedrequestresponse.LegacyStackTestData.AlterTableInvalidDataType;
import static com.dream11.app.expectedrequestresponse.LegacyStackTestData.AlterTableSuccess;
import static com.dream11.app.expectedrequestresponse.LegacyStackTestData.CreateTableEntityExists;
import static com.dream11.app.expectedrequestresponse.LegacyStackTestData.CreateTableInvalidSchema;
import static com.dream11.app.expectedrequestresponse.LegacyStackTestData.CreateTableSuccess;
...
import com.dream11.app.expectedrequestresponse.CassandraFeatureGroupWriteTestData;
...
public class RestIT {
  ...
  // legacy tests
  @Test
  public void createTableEntityExists() {
    JsonObject expectedResponse = CreateTableEntityExists.getJsonObject("response");
    getAndAssertResponse(CreateTableEntityExists.getJsonObject("request"), expectedResponse);
  }

  @Test
  public void createTableSuccess() {
    JsonObject expectedResponse = CreateTableSuccess.getJsonObject("response");
    getAndAssertResponse(CreateTableSuccess.getJsonObject("request"), expectedResponse);
  }

  @Test
  public void createTableInvalidSchema() {
    JsonObject expectedResponse = CreateTableInvalidSchema.getJsonObject("response");
    getAndAssertResponse(CreateTableInvalidSchema.getJsonObject("request"), expectedResponse);
  }

  @Test
  public void alterTableFeatureGroupExists() {
    JsonObject expectedResponse = AlterTableFeatureGroupExists.getJsonObject("response");
    getAndAssertResponse(AlterTableFeatureGroupExists.getJsonObject("request"), expectedResponse);
  }

  @Test
  public void alterTableSuccess() {
    JsonObject expectedResponse = AlterTableSuccess.getJsonObject("response");
    getAndAssertResponse(AlterTableSuccess.getJsonObject("request"), expectedResponse);
  }

  @Test
  public void alterTableInvalidDataType() {
    JsonObject expectedResponse = AlterTableInvalidDataType.getJsonObject("response");
    getAndAssertResponse(AlterTableInvalidDataType.getJsonObject("request"), expectedResponse);
  }
  ...
  @Test
  public void tenantReplicatedSuccessReadWriteFeaturesTest() {
    JsonObject expectedResponse = TenantReplicatedSuccessWriteFeaturesTest.getJsonObject("response");
    getAndAssertResponse(TenantReplicatedSuccessWriteFeaturesTest.getJsonObject("request"), expectedResponse);

    expectedResponse = TenantReplicatedSuccessReadFeaturesTest.getJsonObject("response");
    getAndAssertResponse(TenantReplicatedSuccessReadFeaturesTest.getJsonObject("request"), expectedResponse);
  }

  @Test
  public void successReadPartitionTest() {
    JsonObject expectedResponse = SuccessReadPartitionTest.getJsonObject("response");
    getAndAssertResponse(SuccessReadPartitionTest.getJsonObject("request"), expectedResponse);
  }
}
