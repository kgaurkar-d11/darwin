...
public class ConsumerMailBox {
  ...
  public ConsumerMailBox(Vertx vertx, ClusterManager clusterManager) {
    this.vertx = vertx;
    this.clusterManager = clusterManager;
  }

  public static ConsumerMailBox create(Vertx vertx, ClusterManager clusterManager) {
    return new ConsumerMailBox(vertx, clusterManager);
  }
