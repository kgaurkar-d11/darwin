package com.dream11.consumer.MockServers;


import static com.dream11.consumer.constants.ExpectedDataPath.OfsMockDataPath;
...
public class OfsMock {
  public static final JsonObject serverMocks = new JsonObject(getFileBuffer(OfsMockDataPath));
