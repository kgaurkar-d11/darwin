...
org_name: dream11
environment_name: {{ .Values.env }}
provisioned-by-user: {{ .Values.user | replace "@" "-" }}
service_name: {{ include "spark-history-server.chart" .}}
component_name: {{ include "spark-history-server.name" .}}
component_type: pod
