...
APP_OPTS="-DIGNITE_JETTY_PORT=80 -Dapp.environment=${ENV} -DVPC_SUFFIX=${VPC_SUFFIX} -DTEAM_SUFFIX=${TEAM_SUFFIX} -Dvertx.disableDnsResolver=true -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.SLF4JLogDelegateFactory"
