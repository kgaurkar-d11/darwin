...
INSERT
IGNORE INTO `cassandra_store_feature_group_version_map` (`name`, `latest_version`, `updated_at`)
VALUES ('f400', 'v1', '2024-02-20 08:57:13');

INSERT
IGNORE INTO `cassandra_store_feature_group_version_map` (`name`, `latest_version`, `updated_at`)
VALUES ('f500', 'v2', '2024-02-20 08:57:13');

INSERT
IGNORE INTO `cassandra_store_feature_group_version_map` (`name`, `latest_version`, `updated_at`)
VALUES ('f700', 'v2', '2024-02-20 08:57:13');
...
-- runs --
INSERT
IGNORE INTO `cassandra_store_feature_group_run_data` (`name`, `version`, `run_id`, `source`, `time_taken`, `row_count`, `sample_data`,
  `status`, `error_message`, `timestamp`)
VALUES ('f300', 'v1', 'run1', '', 1000, 100, '[{\"userId\" : 1, \"name\" : \"n1\", \"age\" : 32}]', 'SUCCESS', '', 1740558372);
