...
class Response:
    ...
    @classmethod
    def created_response(cls, message: Any, data: Any = None):
        return cls._response(fastapi.status.HTTP_201_CREATED, "SUCCESS", message, data)

    @classmethod
    def accepted_response(cls, message: Any):
        return cls._response(fastapi.status.HTTP_202_ACCEPTED, "SUCCESS", message)

    @classmethod
    def internal_server_error_response(cls, message: Any, data: Any = None):
    ...
    @classmethod
    def unauthorized_error_response(cls, message: Any):
        return cls._response(fastapi.status.HTTP_401_UNAUTHORIZED, "ERROR", message)
